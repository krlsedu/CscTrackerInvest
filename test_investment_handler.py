...
class TestInvestmentHandlerProfitLoss(unittest.TestCase):
    ...
    def test_add_profit_loss_positive_profit(self, mock_get_correlation_id):
        ...
        self.remote_repository.insert.assert_any_call("transactions", expected_resgate_tx, headers)
        ...
        self.remote_repository.insert.assert_any_call("transactions", expected_lucro_tx, headers)
    ...
    def test_add_profit_loss_negative_profit(self, mock_get_correlation_id):
        ...
        self.remote_repository.insert.assert_any_call("transactions", expected_prejuizo_tx, headers)

    @patch('service.investment_handler.Utils.inform_to_client')
    @patch.object(InvestmentHandler, 'add_profit_loss')
    def test_add_movement_calls_add_profit_loss(self, mock_add_profit_loss, mock_inform_to_client):
