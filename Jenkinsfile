...
pipeline {
    ...
    stages {
        ...
        stage('Docker image') {
            ...
            steps {
                sh 'docker build -t krlsedu/csctracker-invest:' + env.VERSION_NAME + ' -t krlsedu/csctracker-invest:latest  .'
            }
        }
        stage('Docker Push') {
            agent any
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerHub', passwordVariable: 'dockerHubPassword', usernameVariable: 'dockerHubUser')]) {
                    ...
                    sh 'docker push krlsedu/csctracker-invest:' + env.VERSION_NAME
